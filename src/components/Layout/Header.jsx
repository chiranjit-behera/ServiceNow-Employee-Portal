  ...
  return (
    <header className="h-16 bg-slate-800 border-b border-slate-700 flex items-center justify-between px-6 sticky top-0 z-10">
      ...
      <div className="flex items-center space-x-7">
        ...
        <div className="flex items-center space-x-2 text-slate-100 cursor-pointer hover:text-white transition-colors">
        ...
        <button 
          onClick={toggleTheme}
          className="relative h-[28px] w-[52px] bg-slate-700 rounded-full flex items-center px-1 transition-colors hover:bg-slate-600 border border-slate-500/50"
        >
        ...
        <div className="relative" ref={dropdownRef}>
          <button 
            ...
            className="flex items-center space-x-3 focus:outline-none rounded-full pr-2 transition-colors hover:bg-slate-700/50"
          >
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-3 w-[140px] bg-white rounded shadow-lg py-1 z-50 border border-slate-200">
              <button 
              ...
              <button 
                ...
                className="w-full text-left px-4 py-2.5 text-[14px] text-red-600 hover:bg-slate-50 transition-colors"
              >
                Logout
              </button>
            </div>
